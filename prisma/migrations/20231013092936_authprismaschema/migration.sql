/*
  ...
  - The primary key for the `InfoPerson` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
-- AlterTable
ALTER TABLE `InfoPerson` DROP PRIMARY KEY,
