...
import { SelectionOptionA4aCreate } from '@/components/selections/selectionOptions/selectionOptionA/create/SelectionOptionA4aCreate'
...
export default async function InfoSectionA4a() {
                ...
                <div className='bg-warning h-75 w-75 rounded-5 d-flex flex-column align-items-center justify-content-center'>
                  <div className='row h-10'>
                    <InfoSectionNameInput>
                      input 4a: NAME FOURTH PERSON "Those who raised you"
                    </InfoSectionNameInput>
                  </div>
                  <SelectionOptionA4aCreate/>
                </div>
              </div>
            </div>
          </div>
