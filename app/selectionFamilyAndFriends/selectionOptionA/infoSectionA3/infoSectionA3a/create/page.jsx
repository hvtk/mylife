...
import { SelectionOptionA3aCreate } from '@/components/selections/selectionOptions/selectionOptionA/create/SelectionOptionA3aCreate'
...
export default async function InfoSectionA3a() {
                ...
                <div className='bg-warning h-75 w-75 rounded-5 d-flex flex-column align-items-center justify-content-center'>
                  <div className='row h-10'>
                    <InfoSectionNameInput>
                      input 3a: NAME THIRD PERSON "Those who raised you"
                    </InfoSectionNameInput>
                  </div>
                  <SelectionOptionA3aCreate/>
                </div>
              </div>
            </div>
          </div>
