...
import { SelectionOptionA2aCreate } from '@/components/selections/selectionOptions/selectionOptionA/create/SelectionOptionA2aCreate'
                ...
                <div className='bg-warning h-75 w-75 rounded-5 d-flex flex-column align-items-center justify-content-center'>
                  <div className='row h-10'>
                    <InfoSectionNameInput>
                      input 2a: NAME SECOND PERSON "Those who raised you"
                    </InfoSectionNameInput>
                  </div>
                  <SelectionOptionA2aCreate/>
                </div>
              </div>
            </div>
          </div>
