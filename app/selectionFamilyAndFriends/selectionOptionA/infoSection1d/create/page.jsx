...
import { SelectionOptionA1dCreate } from '@/components/selections/selectionOptions/selectionOptionA/create/SelectionOptionA1dCreate'
...
export default async function InfoSection1d() {
                ...
                <div className='bg-warning h-75 w-75 rounded-5 d-flex flex-column align-items-center justify-content-center'>
                  <div className='row h-10'>
                    <InfoSectionNameInput>
                      input 1d: NAME FOURTH PERSON "Those who raised you"
                    </InfoSectionNameInput>
                  </div>
                  <SelectionOptionA1dCreate/>
                </div>
              </div>
            </div>
          </div>
